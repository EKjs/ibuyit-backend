...
import { getAllAds, getNewAds, getAdsByStoreId, getAdsByUserId, getOneAd, createAd, updateAd, deleteAd,getAdsByCatId,getAdsBySubCatId,getAdsByCityId } from '../controllers/ads.js';
...
adsRouter.get('/bystore/:storeId', getAdsByStoreId);
